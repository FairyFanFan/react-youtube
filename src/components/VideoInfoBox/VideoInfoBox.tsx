...
export class VideoInfoBox extends React.Component<any, MyComponentState, VideoListProps> {
  ...
  onToggleCollapseButtonClick = () => {
    this.setState((prevState: MyComponentState) => {
      return {
  ...
  getDescriptionParagraphs() {
    ...
    return videoDescription.split('\n').map((paragraph: any, index: any) => <p key={index}><Linkify>{paragraph}</Linkify></p>);
  }
