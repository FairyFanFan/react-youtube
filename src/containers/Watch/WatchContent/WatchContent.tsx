...
import {Video} from '../../../components/Video/Video';import {VideoMetadata} from '../../../components/VideoMetadata/VideoMetadata';
...
class WatchContent extends React.Component<any> {
  render() {
